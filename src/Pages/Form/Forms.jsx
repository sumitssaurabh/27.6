  ...
  return (
    <form onSubmit={handleSubmit} className="mt-4">
      ...
      <div className="relative flex items-center w-full up_input">
        ...
        />
        {/* <span onClick={togglePasswordVisibility} className="absolute cursor-pointer right-3 top-3">
      ...
      <div className="relative flex items-center w-full up_input">
        ...
        {/* {formData.confirm_password && (
          <span onClick={toggleConfirmPasswordVisibility} className="absolute cursor-pointer right-3 top-3">
